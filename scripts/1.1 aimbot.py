...
send_next = [True]
model = torch.hub.load(r'C:\Users\SahilAmirov\Desktop\Desk\cheats\yolov5' , 'custom', path= r'C:\Users\SahilAmirov\Desktop\Desk\cheats\4.1 best_nano.pt',source='local')
model.conf = 0.40
model.maxdet = 10
model.apm = True 
model.classes = [1]
