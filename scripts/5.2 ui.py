...
serialcomm = serial.Serial("COM4",115200,timeout = 0)
...
silent_toggle = [True]
no_fov_cooldown = [True]                                                                                                              #best_half.onnx
                                                                                                                                      #best_nano.pt
model = torch.hub.load(r'C:\Users\SahilAmirov\Desktop\Desk\cheats\yolov5' , 'custom', path= r'C:\Users\SahilAmirov\Desktop\Desk\cheats\best_nano.pt',source='local')
model.conf = 0.40
model.maxdet = 10
model.apm = True 
model.classes = [1]
